...
def create_app(services: ServiceContainer | None = None) -> FastAPI:
    ...
    templates.env.globals.update(
        ...
        recommendation_overview=ReportStore._recommendation_overview,
        ...
        previous_day_metrics=ReportStore._previous_day_metrics,
        technical_summary=ReportStore._technical_summary,
        evidence_summary=ReportStore._evidence_summary,
        public_evidence_for=ReportStore._public_evidence,
        stock_evidence_for=ReportStore._stock_evidence_for_report,
        has_stock_international_evidence_for=ReportStore._has_stock_international_evidence_for_report,
